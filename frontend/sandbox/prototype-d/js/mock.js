/**
 * Prototype D — 内嵌 mock 数据（内容取材自 theleapchess.com 官网真实文案与商品）
...
export const BRAND = {
  ...
  intro:
    'Born from a lifelong passion for the game, LEAP combines professional-grade accuracy with innovative design — empowering players at every level to focus on what matters most: the next move.',
...
export const VALUES = [
  { title: 'Precision for Players', desc: 'Professional-grade accuracy in every timer, engineered for tournament play.' },
  { title: 'FIDE-Standard Quality', desc: 'Certified clocks with 39 timing modes for official events.' },
  { title: 'Empowering Clubs', desc: 'Supporting 500,000+ chess clubs worldwide — equip, support, win.' },
];

export const JOURNEY = [
  { stage: 'Origin', text: 'Players building for players — born from a lifelong passion for the game.' },
  { stage: 'Grow', text: 'From FIDE-standard timers to creative chess essentials for every level.' },
  { stage: 'Today', text: 'Empowering 500,000+ clubs worldwide to focus on the next move.' },
];
